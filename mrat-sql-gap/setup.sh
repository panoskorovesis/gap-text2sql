...
cd spider-FIT
rm *.*
#export HF_HUB_ENABLE_HF_TRANSFER=0 - with this environment variable do not give warnings, with 1 fail with big files.
export HF_HUB_ENABLE_HF_TRANSFER=0
huggingface-cli download Marchanjo/spider_FIT tables.json --repo-type dataset --local-dir .
...
rm -r soccer_1
huggingface-cli download Marchanjo/spider_FIT resized.zip --repo-type dataset --local-dir .
...
echo
echo "Build English data augmentation by rules and data augmentation by back-translation dataset directory"
...
huggingface-cli download Marchanjo/spider-en-enr-enb train_spider.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-en-enr-enb train_others.json --repo-type dataset --local-dir .
...
echo
echo "Build English non-linear data augmentation (extra question/queries in train_spider.json) 3 x by rules and 1 x by back-translation dataset directory"
echo "The modified versions of train_spider.json, train_others.json, and dev.json are distributed under the CC BY-SA 4.0 license, respecting ShareAlike."
...
huggingface-cli download Marchanjo/spider-en-extra-3enr-1enb train_spider.json --repo-type dataset --local-dir .
...
cd data/spider-pt
huggingface-cli download Marchanjo/spider-pt dev.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-pt train_others.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-pt train_spider.json --repo-type dataset --local-dir .
...
cd data/spider-es
huggingface-cli download Marchanjo/spider-es dev.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-es train_others.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-es train_spider.json --repo-type dataset --local-dir .
...
cd data/spider-fr
huggingface-cli download Marchanjo/spider-fr dev.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-fr train_others.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-fr train_spider.json --repo-type dataset --local-dir .
...
huggingface-cli download Marchanjo/spider-en-pt dev.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-en-pt train_others.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-en-pt train_spider.json --repo-type dataset --local-dir .
...
huggingface-cli download Marchanjo/spider-en-pt-es-fr dev.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-en-pt-es-fr train_others.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-en-pt-es-fr train_spider.json --repo-type dataset --local-dir .
...
echo
echo "Build English, Portuguese, Spanish, French; Data augmentation just in English by rules and by back-translation dataset directory"
echo "The modified versions of train_spider.json, train_others.json, and dev.json are distributed under the CC BY-SA 4.0 license, respecting ShareAlike."
...
huggingface-cli download Marchanjo/spider-en-pt-es-fr-enr-enb train_others.json --repo-type dataset --local-dir .
huggingface-cli download Marchanjo/spider-en-pt-es-fr-enr-enb train_spider.json --repo-type dataset --local-dir .
...
huggingface-cli download Marchanjo/spider-en-pt-es-fr-extra-3enr-3ptr-3esr-3frr train_spider.json --repo-type dataset --local-dir .
...
huggingface-cli download Marchanjo/spider-FIT-en train_spider.json --repo-type dataset --local-dir .
...
echo
echo "Build English data augmentation by rules and data augmentation by back-translation FIT dataset directory"
...
huggingface-cli download Marchanjo/spider-FIT-en-enr-enb train_spider.json --repo-type dataset --local-dir .
...
echo
echo "Build English non-linear data augmentation (extra question/queries in train_spider.json) 3 x by rules and 1 x by back-translation FIT dataset directory"
echo "The modified versions of tables.json, train_spider.json, train_others.json, and dev.json are distributed under the CC BY-SA 4.0 license, respecting ShareAlike."
echo "dev.json is the same as the spider-en, train_others.json is the same as the spider-en"
...
huggingface-cli download Marchanjo/spider-FIT-en-extra-3enr-1enb train_spider.json --repo-type dataset --local-dir .
...
huggingface-cli download Marchanjo/spider-FIT-pt train_spider.json --repo-type dataset --local-dir .
...
huggingface-cli download Marchanjo/spider-FIT-es train_spider.json --repo-type dataset --local-dir .
...
huggingface-cli download Marchanjo/spider-FIT-fr train_spider.json --repo-type dataset --local-dir .
...
huggingface-cli download Marchanjo/spider-FIT-en-pt-es-fr train_spider.json --repo-type dataset --local-dir .
...
echo "The modified versions of tables.json, train_spider.json, train_others.json, and dev.json are distributed under the CC BY-SA 4.0 license, respecting ShareAlike."
echo "dev.json is the same as spider-en-pt-es-fr. train_others.json is the same as spider-en-pt-es-fr"
...
huggingface-cli download Marchanjo/spider-FIT-en-pt-es-fr-extra-3enr-3ptr-3esr-3frr train_spider.json --repo-type dataset --local-dir .
...
echo
echo "Build English, Portuguese, Spanish, French; Data augmentation just in English by rules and by back-translation FIT dataset directory"
echo "The modified versions of tables.json, train_spider.json, train_others.json, and dev.json are distributed under the CC BY-SA 4.0 license, respecting ShareAlike."
echo "dev.json is the same as spider-en-pt-es-fr. train_others.json is the same as spider-en-pt-es-fr-enr-enb"
...
huggingface-cli download Marchanjo/spider-FIT-en-pt-es-fr-enr-enb train_spider.json --repo-type dataset --local-dir .
