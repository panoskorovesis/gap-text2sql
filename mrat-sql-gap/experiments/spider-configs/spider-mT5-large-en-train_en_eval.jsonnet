{
    local exp_id = 1,
    logdir: "logdir/mT5-large-en-train",
    model_config: "configs/mT5-large-en/gap-mT5.jsonnet",
    model_config_args: {
        bs: 4,
    ...
    eval_name: "mT5-large-en-train_en-eval_%d_%s_%d" % [exp_id, self.eval_use_heuristic, self.eval_beam_size],
    eval_output: "ie_dirs/mT5-large-en-train",
    eval_beam_size: 1,
    eval_use_heuristic: true,
    eval_steps: [ 1000 * x + 100 for x in std.range(18, 37)],
    eval_section: "val",
}
