{
    local exp_id = 1,
    logdir: "logdir/mT5-base-gr-train",
    model_config: "experiments/spider-configs/mT5-base-gr/gap-mT5.jsonnet",
    model_config_args: {
        bs: 4,
    ...
    eval_name: "mT5-base-gr-train_gr-eval_%d_%s_%d" % [exp_id, self.eval_use_heuristic, self.eval_beam_size],
